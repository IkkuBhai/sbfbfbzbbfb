...
let educationLevels = [
  ...
  {label: 'Diploma Equavalant to Bachelor degree', value: 'Diploma Equavalant to Bachelor degree'},
  {label: 'Diploma Equavalant to Master degree', value:'Diploma Equavalant to Master degree'},
  {label: 'Online Degree', value:'Online Degree'},
